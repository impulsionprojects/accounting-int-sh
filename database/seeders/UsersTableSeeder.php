...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // Create a dummy company and link it to a user
        $userCompany = Company::create([
            'name'       => 'Impulsion Technology',
            'tax_number' => '123456789',
            'address'    => 'Deira - Office# 402, Bin Sougat Building, near Salah Al Din Metro Station - Al Muraqqabat - Dubai - United Arab Emirates',
            'phone'      => '+971 429 853 960',
            'email'      => 'info@impulsiontechnologies.com',
            'currency'   => 'AED',
        ]);
        ...
        $userCompany->users()->attach($accountant->id);
        $userCompany2->users()->attach($accountant->id);

        $userCompany->users()->attach($company->id);
        ...
        Utility::chartOfAccountData($accountant);
