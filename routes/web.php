...
use App\Http\Controllers\CarInvoiceController;
...
Route::group(['middleware' => ['auth', 'XSS', 'revalidate']], function () {
    Route::get('/switch-company/{companyId}', [UserController::class, 'switchCompany'])->name('switch.company');
...
Route::resource('inventory', InventoryController::class)->middleware(['auth','XSS','revalidate',]);
...
Route::group(
    ...
    Route::get('car-invoice/create/{cid}', [CarInvoiceController::class,'create'])->name('car-invoice.create');
    Route::post('car-invoice/inventory', [CarInvoiceController::class,'inventory'])->name('car-invoice.inventory');
    Route::resource('car-invoice', CarInvoiceController::class);
...
Route::get('/login-to-accounting', [AuthenticatedSessionController::class, 'accountingLogin']);
