...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group  col-md-6">
            {{ Form::label('chart_of_account', __('Chart Of Account'),['class'=>'form-label']) }}
            <div class="form-icon-user">
                <span><i class="ti ti-mobile-alt"></i></span>
                {{ Form::select('account', $accounts,$bankAccount->account, array('class' => 'form-control select','required'=>'required')) }}
            </div>
        </div>
