...
<script>
            ...
            success: function (data) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $(el.parent().parent().find('.item_id')).val(iteams_id);
    ...
    $(document).on('click', '[data-repeater-delete-btn]', function () {
...
@section('content')
    <div class="row">
        {{ Form::model($invoice, array('route' => array('car-invoice.update', $invoice->id), 'method' => 'PUT','class'=>'w-100')) }}
        <div class="col-12">
                    ...
                    <div class="table-responsive">
                        <table class="table mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                {{ Form::hidden('item_id',null, array('class' => 'form-control item_id')) }}
                                <td width="25%" class="form-group pt-0">
                                        {{ Form::select('item', $inventory,null, array('class' => 'form-control item select','data-url'=>route('car-invoice.inventory'))) }}
