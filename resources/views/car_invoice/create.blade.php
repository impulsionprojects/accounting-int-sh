...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{route('car-invoice.index')}}">{{__('Invoice')}}</a></li>
@endsection
@push('script-page')
...
<script>
    ...
    $(document).on('change', '.item', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('.totalAmount').html((parseFloat(totalItemPrice) - parseFloat(totalItemDiscountPrice)).toFixed(2));
    ...
    $(document).on('keyup', '.quantity', function () {
        ...
        var inputs_quantity = 1;

        var priceInput = $('.price');
        for (var j = 0; j < priceInput.length; j++) {
            // totalItemPrice += (parseFloat(priceInput[j].value) * parseFloat(inputs_quantity[j].value));
            totalItemPrice += (parseFloat(priceInput[j].value) * 1);
        }
...
@section('content')
    <div class="row">
        {{ Form::open(array('url' => 'car-invoice','class'=>'w-100')) }}
        <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="row">
                                ...
                                @php
                                    $minDate = \Carbon\Carbon::now()->addDays(5)->toDateString();
                                @endphp
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="form-icon-user">
                                        {{ Form::date('due_date', null, ['class' => 'form-control', 'required' => 'required', 'min' => $minDate]) }}
                                    </div>
                                </div>
                            </div>
...
{{--                                </div>--}}
                        ...
                        <table class="table  mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                ...
                                <td width="25%" class="form-group pt-0">
                                    {{ Form::select('item', $inventory,'', array('class' => 'form-control item','data-url'=>route('car-invoice.inventory'),'required'=>'required')) }}
                                </td>
                                {{-- <td>
        ...
        <div class="modal-footer">
            <input type="button" value="{{__('Cancel')}}" onclick="location.href = '{{route("car-invoice.index")}}';" class="btn btn-light">
