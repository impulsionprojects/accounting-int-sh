...
{{--                <p class="text-body">{{(\App\Models\Utility::getValByName('footer_text')) ? \App\Models\Utility::getValByName('footer_text') :  __('Copyright Impulsion') }} {{ date('Y') }}</p>--}}
                <p class="text-body">
                     Copyright Impulsion {{ date('Y') }}</p>
            </div>
        </div>
    </div>
</section>
