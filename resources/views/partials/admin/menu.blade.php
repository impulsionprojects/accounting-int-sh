    ...
    <div class="navbar-wrapper">
        <div class="m-header main-logo">
            <a href="#" class="b-brand">
                <img src="{{ asset('/assets/images/int_logo.png') }}"
                alt="{{ config('app.name', 'Accounting') }}" class="logo logo-lg" style="height: 80px ; width: 200px; border-radius: 8px">
...
{{--                @endif--}}
                ...
                <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'inventory' || Request::segment(1) == 'productservice'  )?' active dash-trigger':''}}">
                    <a href="#!" class="dash-link "><span class="dash-micon"><i class="ti ti-users"></i></span><span class="dash-mtext">{{__('Product or Services')}}</span>
                        <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
                    </a>
                    <ul class="dash-submenu {{ (Request::segment(1) == 'inventory' || Request::segment(1) == 'productservice' )?'show':''}}">
...
{{--                                <span class="dash-micon"><i class="ti ti-shopping-cart"></i></span>--}}
                                <span class="dash-mtext">{{__('Services')}}</span>
                            </a>
                        </li>
                    </ul>
                </li>

                <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'customer' || Request::segment(1) == 'invoice'  )?' active dash-trigger':''}}">
                    <a href="#!" class="dash-link "><span class="dash-micon"><i class="ti ti-users"></i></span><span class="dash-mtext">{{__('Sales & Payment')}}</span>
                        <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
                    </a>
                    <ul class="dash-submenu {{ (Request::segment(1) == 'customer' || Request::segment(1) == 'invoice')?'show':''}}">
...
{{--                @endif--}}
                ...
                @if( Gate::check('manage bill')  ||  Gate::check('manage payment') ||  Gate::check('manage debit note'))
                    <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'bill' || Request::segment(1) == 'payment' || Request::segment(1) == 'debit-note'  )?' active dash-trigger':''}}">
                        <a href="#!" class="dash-link "><span class="dash-micon"><i class="ti ti-report-money"></i></span><span class="dash-mtext">{{__('Purchase & Expense')}}</span>
                            <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
                        </a>
...
{{--                            @can('manage invoice')--}}
{{--                                <li class="dash-item {{ (Request::route()->getName() == 'car-invoice.index' || Request::route()->getName() == 'invoice.create' || Request::route()->getName() == 'invoice.edit' || Request::route()->getName() == 'invoice.show') ? ' active' : '' }}">--}}
{{--                                    <a class="dash-link" href="{{ route('car-invoice.index') }}">{{__('Car Invoice')}}</a>--}}
{{--                                </li>--}}

{{--                                <li class="dash-item {{ (Request::route()->getName() == 'invoice.index' || Request::route()->getName() == 'invoice.create' || Request::route()->getName() == 'invoice.edit' || Request::route()->getName() == 'invoice.show') ? ' active' : '' }}">--}}
{{--                                    <a class="dash-link" href="{{ route('invoice.index') }}">{{__('Service Invoice')}}</a>--}}
{{--                                </li>--}}
{{--                            @endcan--}}
{{--                            @can('manage revenue')--}}
...
{{--                @endif--}}
                ...
                @if( Gate::check('manage chart of account') ||  Gate::check('manage journal entry') ||   Gate::check('balance sheet report') ||  Gate::check('ledger report') ||  Gate::check('trial balance report'))
                    <li class="dash-item dash-hasmenu {{ (Request::segment(1) == 'chart-of-account' || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance')?' active dash-trigger':''}}">
                        <a href="#!" class="dash-link"><span class="dash-micon"><i class="ti ti-scale"></i></span><span class="dash-mtext">{{__('Accounting')}}</span>
                            <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
                        </a>
