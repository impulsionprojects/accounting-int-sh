...
@section('action-btn')
    <div class="float-end">
        ...
        <a href="#" data-size="lg" data-url="{{ route('productservice.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create Service')}}" class="btn btn-sm btn-primary">
...
{{--                                    <td>{{ $productService->type }}</td>--}}
                                    <td>{{ data_get($productService, 'chartOfAccount.name') }}</td>
