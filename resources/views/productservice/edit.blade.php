...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            {{ Form::label('account', __('Account'),['class'=>'form-label']) }}<span class="text-danger">*</span>
            {{ Form::select('account', $accounts, $productService->account, array('class' => 'form-control select2','required'=>'required')) }}
        </div>
