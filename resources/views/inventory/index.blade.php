...
{{--        <a href="#" data-size="md" data-bs-toggle="tooltip" title="{{__('Import')}}" data-url="{{ route('inventory.file.import') }}" data-ajax-popup="true" data-title="{{__('Import product CSV file')}}" class="btn btn-sm btn-primary">--}}
{{--            <i class="ti ti-file-import"></i>--}}
{{--        </a>--}}
{{--        <a href="{{route('inventory.export')}}" data-bs-toggle="tooltip" title="{{__('Export')}}" class="btn btn-sm btn-primary">--}}
{{--            <i class="ti ti-file-export"></i>--}}
{{--        </a>--}}

{{--        <a href="#" data-size="lg" data-url="{{ route('inventory.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Create')}}" data-title="{{__('Create Product')}}" class="btn btn-sm btn-primary">--}}
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class=" multi-collapse mt-2 {{isset($_GET['category'])?'show':''}}" id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        {{ Form::open(['route' => ['inventory.index'], 'method' => 'GET', 'id' => 'product_service']) }}
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-auto float-end ms-2">
                                ...
                                <a href="{{ route('inventory.index') }}" class="btn btn-sm btn-danger" data-bs-toggle="tooltip"
                                   title="{{ __('Reset') }}">
...
{{--                                <th>{{__('Type')}}</th>--}}
                            ...
                            <tbody>
                            @foreach ($inventory as $productService)
                                <tr class="font-style">
                                        ...
                                        <td class="Action">
                                            @can('edit product & service')
                                                <div class="action-btn bg-info ms-2">
                                                    <a href="#" class="mx-3 btn btn-sm align-items-center" data-url="{{ route('inventory.edit',$productService->id) }}" data-ajax-popup="true" data-size="lg" data-bs-toggle="tooltip" title="{{__('Edit')}}" data-title="{{__('Edit Product')}}">
                                            ...
                                            @can('delete product & service')
                                                <div class="action-btn bg-danger ms-2">
                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['inventory.destroy', $productService->id],'id'=>'delete-form-'.$productService->id]) !!}
